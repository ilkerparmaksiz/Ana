...
// Adjustable Variables
    ...
    Int_t  EventLimit                   = 20; // will limit events to 5
...
//Applying Some Conditions such as Gain, LEDFilter and DarkCount Substraction. 0 is off
    struct sAna {
        ...
        struct Data{
            ...
            UShort_t Th;
            Int_t NofCoinc;
            unsigned ledTriggers;

            std::vector<bool> Condition; //1 is on, 0 is off; Gain,LEDFilter,DarkCount
            std::vector<bool> FilterCondition;
